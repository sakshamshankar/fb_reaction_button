...
class FbReactionState extends State<FbReaction> with TickerProviderStateMixin {
 // late AudioPlayer audioPlayer;
  ...
  String getImageIconBtn() {
    if (!isLongPress && isLiked) {
      return 'images/star.jpg';//'react/images/like.png.png';
    } else if (!isDragging) {
      switch (whichIconUserChoose) {
        case 1:
          return 'images/star.jpg';//'react/images/like.png.png';
        case 2:
          return 'images/star.jpg'; //'react/images/love.png';
        case 3:
          return 'images/star.jpg'; //'react/images/haha.png';
        case 4:
          return 'images/star.jpg'; //'react/images/wow.png';
        case 5:
          return 'images/star.jpg'; //'react/images/sad.png';
        case 6:
          return 'images/star.jpg'; //'react/images/angry.png';
        default:
          return 'images/star.jpg'; //'react/images/like.png';
      }
    } else {
      return 'images/star.jpg'; //'react/images/like.png';
    }
